...
<template>
    <div class="letter bg-white mt-4 rounded-lg shadow-md hover:shadow-lg px-4 py-4">
        <div class="flex flex-nowrap mt-2">
            <p class="text-gray-800">Subscribe our newslatter so you will be notified via email when new post came out</p>
