...
<template>
    <div @click="gotoPage(post.id)" class="post px-4 pb-4 bg-white shadow rounded-lg hover:shadow-lg mt-4">
        <div class="flex flex-col gap-x-3 items-center gap-y-2">
            <div class="image w-full mt-4">
        ...
        <div class="likes_dislikes flex gap-x-4 items-center mt-4">
            <span class="flex gap-x-2 items-center text-red-500 cursor-pointer">
            ...
            <span class="flex gap-x-2 items-center text-blue-500 cursor-pointer">
